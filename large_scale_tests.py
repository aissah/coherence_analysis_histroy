...
if __name__ == "__main__":
    ...
    while len_data < averaging_window_length:
        ...
        next_data = next_data[first_channel:channel_offset+first_channel:int(channel_offset/num_channels)]
        data = np.append(data, next_data[:, :averaging_window_length*samples_per_sec], axis=1)
        len_data = data.shape[1]/samples_per_sec
